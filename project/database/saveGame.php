...
<body>
    ...
    <div class="login-container" style="text-align: center;">
        ...
        <p style="margin-bottom: 20px;"> Hai totalizzato <strong><?php echo $currentScore; ?></strong> punti.</p>
        <p style="font-size: 0.7rem; margin-bottom: 20px;">Vuoi salvare il punteggio?</p>

        <a href="registrationForm.php" class="btn-play">REGISTRATI E SALVA</a>
        <a href="loginForm.php" class="btn-play" style="margin-top: 10px;">HAI GIÀ UN ACCOUNT? LOGIN</a>
        <a href="?action=cancel" class="btn-play" style="border-color: #d32f2f; color: #d32f2f; margin-top: 30px;">TORNA ALLA HOME</a>
    </div>
</body>
</html>
